...
class main extends AWS_CONTROLLER
{
	...
	public function index_action()
	{
		...
		$question_info['question_detail'] = FORMAT::parse_imgs(FORMAT::parse_attachs(nl2br(FORMAT::parse_bbcode($question_info['question_detail']))));
	...
	public function index_square_action()
	{
		...
		// 他们说
		if (TPL::is_output('block/sidebar_users_say.tpl.htm', 'question/square'))
		{
		...
		if ($question_list)
		{
			...
			foreach ($question_list AS $key => $val)
			{
				...
				{
					$question_list[$key]['attachs'] = $question_attachs[$val['question_id']];
				}
			}
			//新增结束
		}
