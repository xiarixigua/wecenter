	...
	public function index_action()
	{
		...
		switch ($topic_info['model_type'])
		{
			default:
				...
				TPL::assign('all_list_bit', TPL::output('topic/ajax/list', false));
				...
				TPL::assign('posts_list', $posts_list);
				TPL::assign('recommend_list_bit', TPL::output('topic/ajax/list', false));
				...
				TPL::assign('all_questions_list_bit', TPL::output('topic/ajax/list', false));
				...
				TPL::assign('articles_list_bit', TPL::output('topic/ajax/list', false));
