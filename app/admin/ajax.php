...
class ajax extends AWS_ADMIN_CONTROLLER
{
    ...
    public function save_settings_action()
    {
		...
		if($_POST['fox_replyid']){
			$config_file = file_get_contents(AWS_PATH . 'config.fdist.php');
			$config_file = str_replace('{FOX_Bangs_num}', $_POST['fox_Bangs_num'], $config_file);
			$config_file = str_replace('{FOX_Gan_num}', $_POST['fox_Gan_num'], $config_file);
			$config_file = str_replace('{FOX_Huo_num}', $_POST['fox_Huo_num'], $config_file);
			$config_file = str_replace('{FOX_tupic}', $_POST['fox_tupic'], $config_file);
			$config_file = str_replace('{FOX_water}', $_POST['fox_water'], $config_file);
			$config_file = str_replace('{FOX_water_w}', $_POST['fox_water_w'], $config_file);
			$config_file = str_replace('{FOX_water_h}', $_POST['fox_water_h'], $config_file);
			$config_file = str_replace('{FOX_ReplyId}', $_POST['fox_replyid'], $config_file);
			$config_file = str_replace('{FOX_users_num}', $_POST['fox_users_num'], $config_file);
			$config_file = str_replace('{FOX_Hfren_num}', $_POST['fox_hfren_num'], $config_file);
			$config_file = str_replace('{FOX_Rzren_num}', $_POST['fox_rzren_num'], $config_file);
			$config_file = str_replace('{FOX_Biao_num}', $_POST['fox_biao_num'], $config_file);
		
			file_put_contents(AWS_PATH . 'configf.inc.php', $config_file);
		}
