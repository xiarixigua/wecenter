(function (e)
{
    function u(u)
    {
        function c()
        {
            ...
            n.animate(
            {
                width : t.width(), height : t.height(), marginTop :- (t.height() / 2) - r, marginLeft :- (t.width() / 2) - r
            },
            200, function ()
            {
                h(t)
    ...
    function a()
    {
        var t = i.parent("div.shibox").prev();
        if (t.length == 0) {
            t = e("#gallery div.shibox:last-child");
        }
        t.find("a").trigger("click")
    }
    function f()
    {
        var t = i.parent("div.shibox").next();
        if (t.length == 0) {
            t = e("#gallery div.shibox:first-child");
        }
    ...
    (function ()
    {
        ...
        if (e("#gallery div.shibox a").length == 1) {
            e("#gallery div.shibox a")[0].addClass("zoom");
        }
        e(".zoom, #gallery div.shibox a").on("click", u)
    })();
    (function ()
    {
